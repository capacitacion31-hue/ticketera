...
class TicketCreationIT extends BaseIntegrationTest {
    ...
    class HappyPath {
        ...
        @Test
        @DisplayName("Crear ticket con datos válidos → 201 + status WAITING + Mensaje")
        void crearTicket_datosValidos_debeCrearConMensaje() {
            ...
            .then()
                ...
                .body("identificador", notNullValue())
                .extract().response();
            ...
            int mensajeCount = countMessages("PENDIENTE");
            assertThat(mensajeCount).isGreaterThanOrEqualTo(1);
        }
        ...
        void crearTickets_diferentesColas_posicionesIndependientes() {
            ...
            // Verificar 4 mensajes creados
            assertThat(countMessages("PENDIENTE")).isGreaterThanOrEqualTo(4);
        }
    }
    ...
    class EdgeCases {
        ...
        void consultarTicket_porCodigo_debeRetornarDatos() {
            ...
            String identificador = createResponse.jsonPath().getString("identificador");

            // When + Then
            given()
            .when()
                .get("/tickets/" + identificador)
            .then()
                .statusCode(200)
                .body("identificador", equalTo(identificador))
                .body("status", equalTo("EN_ESPERA"))
